...
def index():
    sensor_topics = [['/Device/Temperatura-1', 3], ['/Device/Temperatura-2', 3], ['/Device/Humedad-1', 3], ['/Device/Intensidad_Luminosa-1', 3], ]
...
def view_topic(name_d):
    if request.method == 'GET':
        topic = request.form['device']
